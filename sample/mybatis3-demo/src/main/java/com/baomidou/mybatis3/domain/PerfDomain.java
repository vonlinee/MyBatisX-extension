...
public class PerfDomain {
    ...
    public void setIntellij(String intellij) {
        this.intellij = intellij;
    }

    public String getSupposed() {
        return supposed;
    }

    public void setSupposed(String supposed) {
    ...
    public String getMybatisx() {
        return mybatisx;
    }

    public void setMybatisx(String mybatisx) {
        this.mybatisx = mybatisx;
    }
    ...
    public String getDisabling() {
        return disabling;
    }

    public void setDisabling(String disabling) {
    ...
    public String getBothering() {
        return bothering;
    }

    public void setBothering(String bothering) {
        this.bothering = bothering;
    }
    ...
    public void setLiterally(String literally) {
    ...
    public void setHappens(String happens) {
