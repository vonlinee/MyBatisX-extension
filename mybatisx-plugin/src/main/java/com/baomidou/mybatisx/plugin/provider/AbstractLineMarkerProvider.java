 ...
 * @author yanglin
 */
public abstract class AbstractLineMarkerProvider extends RelatedItemLineMarkerProvider {
  ...
  protected void collectNavigationMarkers(@NotNull PsiElement element, @NotNull Collection<? super RelatedItemLineMarkerInfo<?>> result) {
    ...
    Optional<? extends PsiElement[]> processResult = getTargets(element);
   ...
   * @return the optional
   */
  public abstract Optional<? extends PsiElement[]> getTargets(PsiElement from);
  ...
  @NotNull
  public abstract String getTooltip(PsiElement array, @NotNull PsiElement target);
}
