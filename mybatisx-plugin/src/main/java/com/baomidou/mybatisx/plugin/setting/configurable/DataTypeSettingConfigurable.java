...
import com.baomidou.mybatisx.plugin.ui.DataTypeSettingPanel;
...
public final class DataTypeSettingConfigurable implements SearchableConfigurable {
    ...
    public boolean isModified() {
        ...
        if (!StringUtils.equals(String.valueOf(myProperties.getShowNoInMapFieldRadio()), String.valueOf(dataTypeSettingPanel.getShowNoInMapFieldRadio().isSelected()))) {
            return true;
        }
