...
import com.baomidou.mybatisx.dom.model.Association;
import com.baomidou.mybatisx.dom.model.Collection;
import com.baomidou.mybatisx.dom.model.ParameterMap;
          ...
          if (value != null) {
            ...
            if (leastParentType != null) {
              ...
              if (settablePsiField.isPresent()) {
                ...
                Optional<PsiClass> fieldClassOptional = JavaUtils.findClass(project, fieldTypeClassName);
