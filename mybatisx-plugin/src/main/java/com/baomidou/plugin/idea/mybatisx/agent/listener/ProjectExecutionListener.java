package com.baomidou.plugin.idea.mybatisx.agent.listener;
...
import com.baomidou.plugin.idea.mybatisx.agent.util.ProjectUtil;
...
public class ProjectExecutionListener implements ExecutionListener {
    ...
    static {
        try {
            agentJarPath = ProjectUtil.copyToLocal(ProjectExecutionListener.class.getResourceAsStream("/mybatisx-agent.jar"), "mybatisx-agent.jar");
        } catch (IOException e) {
