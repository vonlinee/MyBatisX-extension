package com.baomidou.plugin.idea.mybatisx.jpa.operate.dialect.mysql;

import com.baomidou.plugin.idea.mybatisx.jpa.component.TxField;
import com.baomidou.plugin.idea.mybatisx.jpa.operate.CountOperator;
import com.baomidou.plugin.idea.mybatisx.jpa.operate.DeleteOperator;
import com.baomidou.plugin.idea.mybatisx.jpa.operate.InsertOperator;
import com.baomidou.plugin.idea.mybatisx.jpa.operate.SelectOperator;
import com.baomidou.plugin.idea.mybatisx.jpa.operate.UpdateOperator;
import com.baomidou.plugin.idea.mybatisx.jpa.operate.dialect.BaseDialectManager;
